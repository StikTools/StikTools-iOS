...
build:
	@xcodebuild -project StikTools.xcodeproj \
				...
				ORG_IDENTIFIER=com.Stiktools \
				DWARF_DSYM_FOLDER_PATH="."

fakesign:
	rm -rf archive.xcarchive/Products/Applications/StikTools.app/Frameworks/StikToolsCore.framework/Frameworks/
	ldid -SStikTools/Resources/ReleaseEntitlements.plist archive.xcarchive/Products/Applications/StikTools.app/StikTools
	ldid -SAltWidget/Resources/ReleaseEntitlements.plist archive.xcarchive/Products/Applications/StikTools.app/PlugIns/AltWidgetExtension.appex/AltWidgetExtension
